...
public class MainActivity extends AppCompatActivity {
    ...
    final DatabaseReference dbRef = FirebaseDatabase.getInstance().getReference();
        ...
        //dbRef.child("note");
        //Earlier childEventListener was not on note therefore it was returning all values in onChildAdded
        // ideally only newly added value(String) should be have been returned. Now only new value which is added is returned.
